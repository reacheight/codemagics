  ...
  ['forest']: {
    ...
    [3]: {
      ...
      grid: [
        ...
        ["water","lawn","rock","water","water","lawn","lawn",],
        ["water","water","water","water","water","water","tree",],
      ],
      hero: { x: 2, y: 0 },
      finish: { x: 2, y: 6 },
      gems: [ { x: 2, y: 3 }],
    ...
    [5]: {
      ...
      width: 8,
      grid: [
        ["sand","sand","tree","lawn","water","water","tree","tree"],
    ...
    [6]: {
      ...
      width: 9,
      grid: [
        ["tree","lawn","tree","water","water","water","rock","tree","lawn",],
    ...
    [7]: {
      ...
      width: 9,
      grid: [
        ["tree","tree","lawn","water","water","water","lawn","lawn","rock",],
        ["lawn","sand","sand","water","water","water","sand","sand","sand",],
    ...
    [8]: {
      ...
      width: 9,
      grid: [
        ["lawn","lawn","rock","water","water","water","tree","sand","tree",],
    ...
    [10]: {
      ...
      grid: [
        ...
        ["sand","sand","rock","lawn","lawn","lawn","water","water",],
        ["lawn","sand","lawn","tree","water","water","water","water",],
    ...
    [11]: {
      ...
      width: 13,
      grid: [
        ["tree","tree","tree","water","water","water","water","water","water","water","tree","tree","tree",],
    ...
    [12]: {
      ...
      width: 13,
      grid: [
        ["rock","rock","rock","water","water","sand","grass","tree","water","water","rock","rock","rock",],
    ...
    [13]: {
      ...
      width: 9,
      grid: [
        ["tree","tree","tree","lawn","rock","sand","lawn","water","tree",],
        ["rock","lawn","sand","sand","sand","sand","lawn","water","water",],
        ["water","water","water","water","water","water","water","water","water",],
        ["water","water","water","water","water","water","water","water","water",],
        ["rock","lawn","sand","lawn","lawn","lawn","lawn","sand","water",],
        ["water","lawn","sand","lawn","lawn","rock","lawn","sand","lawn",],
        ["water","water","sand","sand","sand","sand","sand","sand","tree",],
      ],
      hero: { x: 4, y: 7 },
      finish: { x: 1, y: 6 },
      gems: [
    ...
    [15]: {
      ...
      width: 8,
      grid: [
        ["rock","sand","rock","water","water","tree","sand","tree",],
    ...
    [16]: {
      ...
      grid: [
        ...
        ["water","sand","sand","sand","sand","sand","sand","lawn",],
        ["water","water","lawn","sand","lawn","lawn","sand","lawn",],
        ["water","water","water","water","water","rock","sand","lawn",],
    ...
    [17]: {
      ...
      width: 8,
      grid: [
        ["lawn","sand","lawn","lawn","water","water","lawn","lawn",],
        ["sand","sand","lawn","water","water","tree","lawn","lawn",],
        ["rock","water","water","water","water","lawn","lawn","lawn",],
        ["water","water","water","water","water","lawn","sand","sand",],
        ["water","lawn","lawn","tree","water","lawn","sand","rock",],
        ["lawn","sand","sand","lawn","lawn","sand","sand","water",],
        ["tree","sand","rock","lawn","lawn","sand","water","water",],
      ],
      hero: { x: 5, y: 6 },
      finish: { x: 0, y: 6 },
      gems: [
    ...
    [18]: {
      ...
      width: 9,
      grid: [
        ["rock","sand","rock","lawn","water","water","lawn","lawn","lawn",],
        ["lawn","sand","lawn","water","water","water","water","lawn","water",],
        ["lawn","sand","water","water","water","water","water","water","water",],
        ["tree","sand","tree","water","water","water","water","water","water",],
        ["lawn","sand","sand","water","water","water","sand","sand","lawn",],
        ["rock","lawn","rock","water","water","water","water","rock","lawn",],
        ["water","lawn","water","water","water","water","water","water","tree",],
    ...
    [19]: {
      ...
      width: 9,
      grid: [
        ["lawn","water","water","water","water","water","water","water","water"],
    ...
    [20]: {
      ...
      grid: [
        ...
        ["sand","rock","water","water","lawn"],
        ["sand","lawn","lawn","lawn","lawn"],
        ["sand","lawn","tree","lawn","lawn"],
        ["sand","lawn","lawn","lawn","lawn"],
        ["sand","tree","lawn","water","water"],
    ...
    [21]: {
      ...
      width: 9,
      grid: [
        ["water","water","lawn","lawn","rock","water","water","water","water"],
        ["water","lawn","lawn","lawn","lawn","water","water","water","water"],
        ["water","water","water","lawn","lawn","water","water","water","water"],
        ["water","water","tree","lawn","lawn","water","water","water","water"],
        ["water","lawn","lawn","lawn","lawn","water","water","sand","lawn"],
        ["water","water","water","water","water","water","water","sand","lawn"],
    ...
    [22]: {
      ...
      width: 9,
      grid: [
        ["lawn","lawn","tree","lawn","water","water","water","water","water"],
        ["sand","lawn","lawn","lawn","lawn","water","water","water","water"],
        ["sand","sand","sand","lawn","lawn","rock","water","water","water"],
        ["water","lawn","sand","tree","lawn","lawn","lawn","water","water"],
        ["water","water","sand","sand","sand","lawn","lawn","tree","water"],
        ["water","water","water","lawn","sand","lawn","lawn","lawn","rock"],
    ...
    [23]: {
      ...
      width: 13,
      grid: [
        ["lawn","water","tree","water","water","lawn","rock","sand","tree","sand","water","water","water"],
        ...
        ["sand","water","rock","lawn","tree","water","lawn","lawn","lawn","sand","lawn","rock","lawn"],
        ["sand","water","water","lawn","water","water","lawn","rock","tree","sand","water","water","lawn"]
      ],
      hero: { x: 1, y: 0 },
      finish: { x: 1, y: 12 },
      gems: [
